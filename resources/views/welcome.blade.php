...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="bg-white w-full">
                <header class="absolute inset-x-0 top-0 z-50 mx-auto">
                  <nav class="flex items-center  p-6 lg:px-8 m-auto justify-center" aria-label="Global">
                    <div class="flex justify-center">
                    {{-- we add ts for centerilise things --}}
                      ...
                      {{-- <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-10 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white"> --}}
                        @if (Route::has('login'))
                            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                                @auth
                                    <a href="{{ url('/dashboard') }}" class="font-semibold text-indigo-600  dark:text-gray-400 dark:hover:text-white">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="font-semibold text-indigo-600 dark:text-gray-400 dark:hover:text-white">Log in</a>
            
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 font-semibold text-indigo-600 dark:text-gray-400 dark:hover:text-white ">Register</a>
                                    @endif
                                @endauth
                            </div>
                        @endif
